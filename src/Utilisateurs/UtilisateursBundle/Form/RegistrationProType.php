...
class RegistrationProType extends RegistrationFormType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
                ...
                ->add('ville_entreprise','text', array('attr' => array('class' => 'input form-control'),'label' => 'Ville de domiciliation*','required' => true))
                ->add('telephone_entreprise','text', array('attr' => array('class' => 'input form-control'),'label' => 'Téléphone 1*','required' => true))
                ->add('cp_entreprise','text', array('attr' => array('class' => 'input form-control'),'label' => 'Code postal*','required' => true))
                ->add('telephonefix_entreprise','text', array('attr' => array('class' => 'input form-control'),'label' => 'Téléphone 2','required' => false))
                ->add('rue_entreprise','text', array('attr' => array('class' => 'input form-control'),'label' => 'Numéro et nom de rue*','required' => true))
                ...
                ->add('adresse','text', array('attr' => array('class' => 'input form-control'),'label' => 'Numéro et nom de rue*','required' => true))
