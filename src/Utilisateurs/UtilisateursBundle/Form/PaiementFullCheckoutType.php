...
class PaiementFullCheckoutType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
                ...
                ->add('moisexp','choice',array('choices' => array('01' => 'Janvier',
                                                                    '02' => 'Février',
                                                                    '03' => 'Mars',
                                                                    '04' => 'Avril',
                                                                    '05' => 'Mai',
                                        ...
                                        'label' => 'Mois exp.*',
                                        'attr' => array('class' => 'select form-control')))
                ->add('anneeexp','choice',array('choices' => array('2018' => '2018',
                                                                    '2019' => '2019',
                                                                    '2020' => '2020',
                                                                    '2021' => '2021',
                                                                    '2022' => '2022',
    ...
    {
        return 'utilisateurs_utilisateursbundle_paiement_full_checkout';
    }
