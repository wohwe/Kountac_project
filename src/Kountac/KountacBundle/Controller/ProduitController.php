...
class ProduitController extends Controller
{
	...
	$produit_marque = $em->getRepository('KountacBundle:Produits_1')->find($marque);
        ...
        //$tailleProduits = $em->getRepository('KountacBundle:Produits')->getProduitsByTaille($taille, $id);
