 ...
 */
class Libelles_motif extends \Kountac\KountacBundle\Entity\Libelles_motif implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Kountac\\KountacBundle\\Entity\\Libelles_motif' . "\0" . 'id', '' . "\0" . 'Kountac\\KountacBundle\\Entity\\Libelles_motif' . "\0" . 'mannequin', '' . "\0" . 'Kountac\\KountacBundle\\Entity\\Libelles_motif' . "\0" . 'libelle', 'path', 'file'];
        }

        return ['__isInitialized__', '' . "\0" . 'Kountac\\KountacBundle\\Entity\\Libelles_motif' . "\0" . 'id', '' . "\0" . 'Kountac\\KountacBundle\\Entity\\Libelles_motif' . "\0" . 'mannequin', '' . "\0" . 'Kountac\\KountacBundle\\Entity\\Libelles_motif' . "\0" . 'libelle', 'file'];
    }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Libelles_motif $proxy) {
