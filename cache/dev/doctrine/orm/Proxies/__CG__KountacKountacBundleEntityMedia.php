 ...
 */
class Media extends \Kountac\KountacBundle\Entity\Media implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = ['path' => NULL, 'path2' => NULL];
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Kountac\\KountacBundle\\Entity\\Media' . "\0" . 'id', 'path', 'path2', 'file', 'file2'];
        }

        return ['__isInitialized__', '' . "\0" . 'Kountac\\KountacBundle\\Entity\\Media' . "\0" . 'id', 'file', 'file2'];
    }
