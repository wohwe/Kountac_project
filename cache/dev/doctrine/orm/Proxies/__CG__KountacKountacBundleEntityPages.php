 ...
 */
class Pages extends \Kountac\KountacBundle\Entity\Pages implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Kountac\\KountacBundle\\Entity\\Pages' . "\0" . 'id', '' . "\0" . 'Kountac\\KountacBundle\\Entity\\Pages' . "\0" . 'lien', '' . "\0" . 'Kountac\\KountacBundle\\Entity\\Pages' . "\0" . 'titre', '' . "\0" . 'Kountac\\KountacBundle\\Entity\\Pages' . "\0" . 'type', '' . "\0" . 'Kountac\\KountacBundle\\Entity\\Pages' . "\0" . 'categorie', '' . "\0" . 'Kountac\\KountacBundle\\Entity\\Pages' . "\0" . 'contenu'];
        }
