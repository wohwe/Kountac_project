 ...
 */
class Reservations extends \Kountac\KountacBundle\Entity\Reservations implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Kountac\\KountacBundle\\Entity\\Reservations' . "\0" . 'id', '' . "\0" . 'Kountac\\KountacBundle\\Entity\\Reservations' . "\0" . 'produit', '' . "\0" . 'Kountac\\KountacBundle\\Entity\\Reservations' . "\0" . 'utilisateur', '' . "\0" . 'Kountac\\KountacBundle\\Entity\\Reservations' . "\0" . 'marque', '' . "\0" . 'Kountac\\KountacBundle\\Entity\\Reservations' . "\0" . 'date'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Reservations $proxy) {
