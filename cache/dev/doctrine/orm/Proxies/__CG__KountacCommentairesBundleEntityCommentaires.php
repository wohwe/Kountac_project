...
namespace Proxies\__CG__\Kountac\CommentairesBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Commentaires extends \Kountac\CommentairesBundle\Entity\Commentaires implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Kountac\\CommentairesBundle\\Entity\\Commentaires' . "\0" . 'id', '' . "\0" . 'Kountac\\CommentairesBundle\\Entity\\Commentaires' . "\0" . 'produit', '' . "\0" . 'Kountac\\CommentairesBundle\\Entity\\Commentaires' . "\0" . 'titre', '' . "\0" . 'Kountac\\CommentairesBundle\\Entity\\Commentaires' . "\0" . 'pseudo', '' . "\0" . 'Kountac\\CommentairesBundle\\Entity\\Commentaires' . "\0" . 'contenu', '' . "\0" . 'Kountac\\CommentairesBundle\\Entity\\Commentaires' . "\0" . 'date'];
        }
