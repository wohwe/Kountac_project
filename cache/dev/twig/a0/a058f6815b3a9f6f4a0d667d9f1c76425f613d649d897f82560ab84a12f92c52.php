...
class __TwigTemplate_f9fea4595e0f18cce55b9f767bacdc695b41d32774cb678e64d1f650f6c4952e extends \Twig\Template
{
...
";
        ...
        foreach ($context['_seq'] as $context["position"] => $context["e"]) {
            // line 38
            echo "    ";
            $this->loadTemplate("@Twig/Exception/traces.html.twig", "@Twig/Exception/exception.html.twig", 38)->display(["exception" => $context["e"], "position" => $context["position"], "count" => ($context["previous_count"] ?? $this->getContext($context, "previous_count"))]);
        }
        $_parent = $context['_parent'];
...
";
        ...
        <div id=\"logs\">
            ";
            // line 64
            $this->loadTemplate("@Twig/Exception/logs.html.twig", "@Twig/Exception/exception.html.twig", 64)->display(["logs" => $this->getAttribute(($context["logger"] ?? $this->getContext($context, "logger")), "logs", [])]);
            // line 65
            echo "        </div>
    </div>
";
...
";
        // line 89
        $this->loadTemplate("@Twig/Exception/traces_text.html.twig", "@Twig/Exception/exception.html.twig", 89)->display(["exception" => ($context["exception"] ?? $this->getContext($context, "exception"))]);
        // line 90
        echo "
...
//]]></script>
", "@Twig/Exception/exception.html.twig", "C:\\xampp\\htdocs\\Projet test\\Kountac_project\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle\\Resources\\views\\Exception\\exception.html.twig");
    }
}
